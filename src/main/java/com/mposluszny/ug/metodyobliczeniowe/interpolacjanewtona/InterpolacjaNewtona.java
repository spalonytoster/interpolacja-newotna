package com.mposluszny.ug.metodyobliczeniowe.interpolacjanewtona;
import java.io.File;
...
public class InterpolacjaNewtona {
	...
	public void getUserInput() {
		...
		System.out.println("Podaj warto�ci x:");
		...
		System.out.println("Podaj warto�ci y:");
		...
		try {
			...
			System.err.println("Podano nieprawid�ow� ilo�� danych wej�ciowych.");
		}
